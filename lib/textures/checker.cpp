...
QSharedPointer<Texture> Checker::parse_json(const QJsonObject &json) {
    return QSharedPointer<Checker>::create(parse_json_color(json, "odd"), parse_json_color(json, "even"), parse_json_double(json, "dx", eps), parse_json_double(json, "dy", eps), parse_json_double(json, "dz", eps));
}